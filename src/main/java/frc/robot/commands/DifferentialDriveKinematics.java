...
public class DifferentialDriveKinematics extends CommandBase {

  private final DriveSubsystem driveSubsystem;
  private final DoubleSupplier kForwardSpeed, kSidewaysSpeed, kAngularSpeed;

  /** Creates a new ArcadeDriveCommand. */
  public DifferentialDriveKinematics(DriveSubsystem driveSubsystem, DoubleSupplier xVelocity, DoubleSupplier yVelocity, DoubleSupplier angularRate) {
